  ...
  return (
    <HelmetProvider>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center transition-colors duration-300">
        <Helmet>
          <title>Login - Connexion à Data Manager</title>
          <meta
            name="description"
            content="Connectez-vous à Data Manager pour gérer vos données efficacement et accéder à vos statistiques."
          />
          <meta
            name="keywords"
            content="connexion, login, gestion des données, Data Manager, application"
          />
        </Helmet>
